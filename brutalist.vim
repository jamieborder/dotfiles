...
" let s:guifg_string="#ffa800"
let s:guifg_string="#ff3060"
let s:ctermfg_string="12"

" Constants (numbers)
let s:guifg_const="#ffa800"
" let s:guifg_const="#ff3060"
let s:ctermfg_const="12"
...
let s:guifg_paren_match="#bbbbff"
...
exec 'highlight Constant guifg=' . s:guifg_const . ' ctermfg=' . s:ctermfg_const . ' guibg=' . s:guibg . ' ctermbg=' . s:ctermbg . ' gui=NONE cterm=NONE'
